...
- NEW `docs/09_jetson_companion.md` — role, endpoints, deploy command, curl examples, HotSpot/Android (BL-65) context, NTP handling, why port 8090 (8080 taken by filebrowser).
